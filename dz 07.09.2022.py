...
"Дописать приложение, Необходимо добавить возможность хранения \
в одном списке/файле студентов и прподавателей. Обратить внимание на методі чтения/записи в файл."
